...
export const WSTEP = {
  ...
  akapity: [
    ...
    "Zasada, która tłumaczy najwięcej: panel prawie nigdy nie kontaktuje się z nikim za Ciebie i nigdy nie podejmuje decyzji. Automaty przygotowują, przypominają i pilnują — decyzję zawsze klikasz Ty. Dlatego zamiast „system wysłał ofertę” masz „system przygotował szkic i czeka”. Jest DOKŁADNIE JEDEN wyjątek i trzeba go znać: zaległa faktura z wpisanym adresem e-mail sama dostaje przypomnienia o płatności — uprzejme po 3 dniach i stanowcze po 10 (patrz Faktury → „Co dzieje się samo”). Na tym automat się kończy: formalne wezwanie do zapłaty z odsetkami NIE wychodzi samo — po 21 dniach czeka na Pulpicie w sekcji „Wezwanie czeka na Twoją decyzję”. Nic innego nie wychodzi z panelu bez Twojego kliknięcia.",
  ...
  },
  {
    ...
    automaty: [
      ...
      },
      {
        ...
        opis:
          "To jest jedyne miejsce, w którym panel pisze do klienta bez Twojego kliknięcia. Wystawiona faktura po terminie, z wpisanym adresem e-mail nabywcy, dostaje z porannego przebiegu: po 3 dniach uprzejme przypomnienie, po 10 — stanowcze. I na tym automat się kończy. Formalne WEZWANIE DO ZAPŁATY z odsetkami — trzeci poziom — od 7 sierpnia 2026 NIE wychodzi samo: po 21 dniach faktura pojawia się na Pulpicie w sekcji „Wezwanie czeka na Twoją decyzję”, z przyciskiem „Wyślij wezwanie”. Powód jest prosty: to pismo o innym ciężarze niż przypomnienie i czasem trafiłoby do klienta, z którym rozmawiałeś wczoraj przez telefon. Każdy poziom idzie najwyżej raz, a Twoje ręczne kliknięcie liczy się jako ten poziom, więc klient nie dostanie tego samego dwa razy. Nie chcesz, żeby uprzejme i stanowcze przypomnienie poszło samo — usuń adres e-mail z faktury, ustaw status „Anulowana” albo unieważnij link (automat pomija fakturę z unieważnionym linkiem).",
      },
      {
