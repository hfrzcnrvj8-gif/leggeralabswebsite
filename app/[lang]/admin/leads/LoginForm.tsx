      ...
      <form onSubmit={submit} className="space-y-3">
        {etap === "haslo" ? (
          <input
            ...
            placeholder="Hasło"
            autoFocus
            className="w-full rounded-lg border hairline bg-transparent px-4 py-3 text-sm text-[var(--fg)] outline-none transition-colors focus:border-zaznaczenie/60"
          />
        ) : (
          <>
            <input
              ...
              autoFocus
              className="w-full rounded-lg border hairline bg-transparent px-4 py-3 text-center text-lg tracking-[0.3em] text-[var(--fg)] outline-none transition-colors focus:border-zaznaczenie/60"
            />
