...
| 38 | ⏭️ **NASTĘPNY. Eksporty CSV + reszta spójności** — domyka Moduł 37. Właściciel rozstrzygnął 2026-07-22: **czas pracy ze stopera, wiersz podsumowania, eksport klientów i projektów**; CSV zostaje (format jest już pod polski Excel), eksportu w apce NIE robimy. Zawiera listę pięciu „odstępstw", które okazały się świadomymi decyzjami — nie zgłaszaj ich drugi raz | średni | [38-eksporty-i-reszta-spojnosci.md](38-eksporty-i-reszta-spojnosci.md) |
