...
| 37 | ⏭️ **NASTĘPNY. Standard branżowy (Linear/Notion) + eksport do Excela** — pytanie właściciela 2026-07-20. Dotyczy **panelu I apki natywnej naraz** (jedyny taki brief w tym folderze). Zawiera gotowy wynik audytu spójności wizualnej apki iOS z 2026-07-20 (nie robić drugi raz) i cztery pytania rozstrzygające zakres Excela. Rekomendacja: **eksport, nie synchronizacja dwukierunkowa**. **Zaktualizowany 2026-07-22**: dług A1 już zrobiony, eksport CSV już istnieje (leady/faktury/koszty), doszły cztery ekrany nieobjęte audytem — czytaj sekcję „Aktualizacja 2026-07-22” | duży, w dużej części rozmowa | [37-standard-branzowy-i-excel.md](37-standard-branzowy-i-excel.md) |
