...
| 25 | ⏳ Menu kontekstowe (prawy przycisk) — `onContextMenu` nie występuje dziś w kodzie ani razu. Brief odświeżony 2026-07-17: `Popover` trzeba rozszerzyć **wstecznie zgodnie** (ma już ~20 konsumentów, w tym dzwonek z Modułu 24), a Poczta trzyma własne ręczne menu omijające `Menu.tsx` — kandydat na „12 kopii → 1" jak w Module 21. Zacznij od pytań (czy menu ma dokładać akcje bez przycisku: kopiuj e-mail/NIP/otwórz w nowej karcie) | średni | [25-menu-kontekstowe.md](25-menu-kontekstowe.md) |
