...
| 41 | ⏭️ **NASTĘPNY.** 🔑 **Drugi składnik logowania (TOTP)** — prompt: [PROMPT-41.md](PROMPT-41.md). **Drogi powrotu ustalone 2026-07-22:** papierowe kody zapasowe + ten sam sekret na dwóch urządzeniach; drugie konto administratora odrzucone (osobny, większy moduł); wyłącznik w Vercelu zostaje jako trzecia droga, bo prowadzi przez łańcuch zerwany przez pół roku (ustalenie 12). — właściciel poprosił o 2FA 2026-07-22, **znosząc zapis „jedno hasło" z `CLAUDE.md`**. Hamulec z Audytu 1 zamyka zgadywanie, nie zamyka wycieku hasła. Kody zapasowe obowiązkowe (nie ma administratora, który by odblokował konto) + wyłącznik awaryjny przez zmienną w Vercelu | średni | [41-drugi-skladnik-totp.md](41-drugi-skladnik-totp.md) |
